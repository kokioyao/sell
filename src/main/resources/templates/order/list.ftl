...
<div class="modal fade" id="myContainer" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/sell/seller/order/list" type="button" class="btn btn-primary">查看新的订单</a>
            </div>
        </div>
...
<script>
    ...
    if ('websocket' in window) {
        websocket = new WebSocket('ws://footman77.natapp1.cc/sell/webSocket');
    } else {
        alert("浏览器不支持，请下载chrome")
    }
